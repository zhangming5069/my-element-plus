...
const _sfc_main = vue.defineComponent({
  ...
  emits: [event.UPDATE_MODEL_EVENT, event.CHANGE_EVENT, "close", "expandChange"],
  setup(props, { emit, slots }) {
    ...
    const expandNode = (node, silent) => {
      ...
      if (((_a = expandingNode.value) == null ? void 0 : _a.uid) !== (newExpandingNode == null ? void 0 : newExpandingNode.uid)) {
        ...
        !silent && emit("expandChange", (node == null ? void 0 : node.pathValues) || []);
      }
    };
...
var CascaderPanel = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["render", _sfc_render], ["__file", "/Users/sunzsh/Documents/personal/githubs/element-plus/packages/components/cascader-panel/src/index.vue"]]);
