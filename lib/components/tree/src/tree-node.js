...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, ctx) {
    ...
    const handleContextMenu = (event) => {
      ...
      tree.ctx.emit("nodeContextmenu", event, props.node.data, props.node, instance);
    };
    ...
    const handleChildNodeExpand = (nodeData, node, instance2) => {
      ...
      tree.ctx.emit("nodeExpand", nodeData, node, instance2);
    };
...
var ElTreeNode = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["render", _sfc_render], ["__file", "/Users/sunzsh/Documents/personal/githubs/element-plus/packages/components/tree/src/tree-node.vue"]]);
