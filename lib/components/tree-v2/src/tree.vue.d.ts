declare const _default: import("vue").DefineComponent<{
    ...
    nodeClick: (data: import("../../tree/src/tree.type").TreeNodeData, node: import("./types").TreeNode, e: MouseEvent) => MouseEvent;
    nodeExpand: (data: import("../../tree/src/tree.type").TreeNodeData, node: import("./types").TreeNode) => import("./types").TreeNode;
    nodeCollapse: (data: import("../../tree/src/tree.type").TreeNodeData, node: import("./types").TreeNode) => import("./types").TreeNode;
    currentChange: (data: import("../../tree/src/tree.type").TreeNodeData, node: import("./types").TreeNode) => import("./types").TreeNode;
    ...
    nodeContextmenu: (event: Event, data: import("../../tree/src/tree.type").TreeNodeData, node: import("./types").TreeNode) => import("./types").TreeNode;
    ...
    onCurrentChange?: ((data: import("../../tree/src/tree.type").TreeNodeData, node: import("./types").TreeNode) => any) | undefined;
    onNodeExpand?: ((data: import("../../tree/src/tree.type").TreeNodeData, node: import("./types").TreeNode) => any) | undefined;
    ...
    onNodeClick?: ((data: import("../../tree/src/tree.type").TreeNodeData, node: import("./types").TreeNode, e: MouseEvent) => any) | undefined;
    onNodeContextmenu?: ((event: Event, data: import("../../tree/src/tree.type").TreeNodeData, node: import("./types").TreeNode) => any) | undefined;
    onNodeCollapse?: ((data: import("../../tree/src/tree.type").TreeNodeData, node: import("./types").TreeNode) => any) | undefined;
}, {
