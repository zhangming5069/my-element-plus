...
export declare const NODE_CLICK = "nodeClick";
export declare const NODE_EXPAND = "nodeExpand";
export declare const NODE_COLLAPSE = "nodeCollapse";
export declare const CURRENT_CHANGE = "currentChange";
export declare const NODE_CHECK = "check";
export declare const NODE_CHECK_CHANGE = "checkChange";
export declare const NODE_CONTEXTMENU = "nodeContextmenu";
export declare const treeEmits: {
    nodeClick: (data: TreeNodeData, node: TreeNode, e: MouseEvent) => MouseEvent;
    nodeExpand: (data: TreeNodeData, node: TreeNode) => TreeNode;
    nodeCollapse: (data: TreeNodeData, node: TreeNode) => TreeNode;
    currentChange: (data: TreeNodeData, node: TreeNode) => TreeNode;
    check: (data: TreeNodeData, checkedInfo: CheckedInfo) => CheckedInfo;
    checkChange: (data: TreeNodeData, checked: boolean) => boolean;
    nodeContextmenu: (event: Event, data: TreeNodeData, node: TreeNode) => TreeNode;
};
