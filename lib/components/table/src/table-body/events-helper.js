...
function useEvents(props) {
  ...
  const handleCellMouseEnter = (event, row, tooltipEffect) => {
    ...
    if (cell) {
      ...
      table == null ? void 0 : table.emit("cellMouseEnter", hoverState.row, hoverState.column, hoverState.cell, event);
    }
  ...
  const handleCellMouseLeave = (event) => {
    ...
    parent == null ? void 0 : parent.emit("cellMouseLeave", oldHoverState == null ? void 0 : oldHoverState.row, oldHoverState == null ? void 0 : oldHoverState.column, oldHoverState == null ? void 0 : oldHoverState.cell, event);
  };
  return {
    handleDoubleClick,
    handleClick,
