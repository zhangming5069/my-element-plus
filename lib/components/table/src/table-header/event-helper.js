...
function useEvent(props, emit) {
  ...
  const handleHeaderClick = (event, column) => {
    ...
    parent == null ? void 0 : parent.emit("headerClick", column, event);
  };
  const handleHeaderContextMenu = (event, column) => {
    parent == null ? void 0 : parent.emit("headerContextmenu", column, event);
  };
    ...
    if (draggingColumn.value && props.border) {
      ...
      const handleMouseUp = () => {
        if (dragging.value) {
          ...
          table == null ? void 0 : table.emit("headerDragend", column.width, startLeft - startColumnLeft, column, event);
