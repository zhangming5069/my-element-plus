...
const paginationEmits = {
  "update:currentPage": (val) => typeof val === "number",
  "update:pageSize": (val) => typeof val === "number",
  sizeChange: (val) => typeof val === "number",
  currentChange: (val) => typeof val === "number",
  prevClick: (val) => typeof val === "number",
  nextClick: (val) => typeof val === "number"
};
...
var Pagination = vue.defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const hasCurrentPageListener = "onUpdate:currentPage" in vnodeProps || "onUpdate:currentPage" in vnodeProps || "onCurrentChange" in vnodeProps;
    const hasPageSizeListener = "onUpdate:pageSize" in vnodeProps || "onUpdate:pageSize" in vnodeProps || "onSizeChange" in vnodeProps;
